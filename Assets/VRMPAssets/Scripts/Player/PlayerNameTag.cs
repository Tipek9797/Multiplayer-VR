...
namespace XRMultiplayer
{
    public class PlayerNameTag : MonoBehaviour
    {
        ...
        public void SetupNameTag(XRINetworkPlayer player)
        {
            ...
            m_ColoredImage.color = Random.ColorHSV(0f, 1f, 0.6f, 1f, 0.6f, 1f);;
        ...
        void UpdateNameTagSize()
        {
            ...
            m_NameTagText.ForceMeshUpdate();

            float preferredWidth = m_NameTagText.preferredWidth * m_NameTextScale;

            float finalWidth = Mathf.Max(100f, preferredWidth);

            var rect = m_NameTagText.rectTransform;
